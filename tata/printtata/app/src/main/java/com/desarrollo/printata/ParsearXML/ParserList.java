...
public class ParserList {
    ...
    private static final String ETIQUETA_3= "ObtenerDatosListaArticuloEtiquetasResponse";

    private static final String ETIQUETA_4= "ObtenerDatosListaArticuloEtiquetasResult";
    ...
    private List_Producto RegistrarProducto(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        return new List_Producto(DescArticulo_1,DescArticulo_2,CodProd,CodBarras,Precio,Stock,off_available,IP,Suc,Estado,txt_oferta);
    }
